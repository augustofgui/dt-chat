  ...
  return (
    <Controller
      ...
      render={({
        ...
        const emptyOrFilled = value ? colors.lightBlue[600] : colors.gray[300];
        ...
        return (
          <VStack w="full" flex={flex}>
            <NativeBaseInput
              ...
              selectionColor="lightBlue.600"
              cursorColor="lightBlue.600"
              isInvalid={!!error}
              mb={4}
              flex={flex}
              _focus={{
                borderColor: error ? 'red.400' : 'lightBlue.600',
                bg: 'gray.700',
              }}
              _invalid={{
                borderColor: 'red.400',
              ...
              InputLeftElement={
                LeftIcon ? (
                  <Icon as={<LeftIcon color={leftIconColor} />} ml={3} />
                ) : undefined
              }
            ...
            {!!error && (
              <Text fontSize="sm" mt="1" mb={4} color="red.400">
                {error.message}
              </Text>
            )}
          </VStack>
